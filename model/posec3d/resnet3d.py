...
class ConvBNLayer(nn.Cell):
    ...
    def __init__(
        ...
        self._batch_norm = nn.BatchNorm3d(out_channels, momentum=0.9)
        self.act = act
        if act is not None:
    ...
    def __init__(self,
        ...
        if self.inflate:
            if inflate_style == '3x1x1':
                ...
                conv1_padding = (1, 1, 0, 0, 0, 0)
                conv2_kernel_size = (1, 3, 3)
                conv2_padding = (0, 0, dilation, dilation, dilation, dilation)
            else:
                conv1_kernel_size = (1, 1, 1)
                conv1_padding = (0, 0, 0, 0, 0, 0)
                conv2_kernel_size = (3, 3, 3)
                conv2_padding = (1, 1, dilation, dilation, dilation, dilation)
        else:
            conv1_kernel_size = (1, 1, 1)
            conv1_padding = (0, 0, 0, 0, 0, 0)
            conv2_kernel_size = (1, 3, 3)
...
class ResNet3d(nn.Cell):
    ...
    def __init__(self,
        ...
        self.non_local_stages = non_local
        self.inflate_style = inflate_style
        self.conv_cfg = conv_cfg
        self.norm_cfg = norm_cfg
        self.act_cfg = act_cfg
