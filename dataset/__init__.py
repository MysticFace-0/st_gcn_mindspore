...
from .flag2d_posec3d import FLAG2DPoseC3DTrainDatasetGenerator, FLAG2DPoseC3DValDatasetGenerator, FLAG2DPoseC3DTestDatasetGenerator
...
__all__ = [
    ...
    'FLAG2DPoseC3DTrainDatasetGenerator', 'FLAG2DPoseC3DValDatasetGenerator', 'FLAG2DPoseC3DTestDatasetGenerator'
]